...
const AmbassadorPage: React.FunctionComponent<AmbassadorPageProps> = () => {
  ...
  return (
    <AmbassadorPageWrap>
      <Helmet>
        <title>Cicada Ambassador & Funding Program</title>
        <meta
          name="description"
      ...
      <GrantBannerWrap>
        <BannerContentWrap>
          ...
          >
            {t('Cicada Ambassador & Funding Program')}
          </BannerTitle>
          <BannerDescription
            style={{ color: '#fff', maxWidth: '782px', fontSize: '16px', fontWeight: 400, lineHeight: '28px' }}
          >
            {t(
